...
satisfied-criteria: []
criterion-statuses: {"inventory":[],"clean-integration":[],"mvc-contract":[],"history-integrity":[],"baseline-tests":[],"rollback":[]}
...
- [ ] **inventory:** Existe un inventario reproducible por series coherentes, clasificado como portar, ya-presente, obsoleto o descartar, con justificación y owner.; stages: none
- [ ] **clean-integration:** La rama parte de origin/main y no contiene conflictos, cambios accidentales ni pérdida de trabajo del usuario; sólo se portan cambios aprobados por el inventario.; stages: none
- [ ] **mvc-contract:** La decisión MVC/CICS vigente en main queda documentada y sus tres pruebas focalizadas permanecen verdes.; stages: none
- [ ] **history-integrity:** SHAs de entrada, merge-base, range-diff, patch-id, commits portados/descartados y relación entre las épicas #205/#221 quedan registrados de forma reproducible.; stages: none
- [ ] **baseline-tests:** El reactor alcanza el primer fallo real de main sin regresiones introducidas; las pruebas relevantes y su salida quedan registradas.; stages: none
- [ ] **rollback:** Existe una referencia recuperable al estado previo y un procedimiento documentado que no requiere reescritura destructiva.; stages: none
