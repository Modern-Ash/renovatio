...
satisfied-criteria: []
criterion-statuses: {"domain-language":["specified","planned","implemented"],"goto-plan":["specified","planned","implemented"],"human-confirmation":["specified","planned"],"manual-actions":["specified","planned"],"residual-only":["specified","planned","implemented"]}
