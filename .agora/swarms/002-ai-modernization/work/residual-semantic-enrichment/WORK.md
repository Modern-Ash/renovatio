...
satisfied-criteria: []
criterion-statuses: {"domain-language":["specified","planned"],"goto-plan":["specified","planned"],"human-confirmation":["specified","planned"],"manual-actions":["specified","planned"],"residual-only":["specified","planned"]}
...
- [ ] **residual-only:** Supported deterministic constructs never invoke the LLM enrichment path.; stages: specified, planned
