...
satisfied-criteria: ["golden-fixtures","gate-order","safe-fallback","offline-ci"]
criterion-statuses: {"golden-fixtures":["specified","planned","implemented","verified","accepted"],"gate-order":["specified","planned","implemented","verified","accepted"],"safe-fallback":["specified","planned","implemented","verified","accepted"],"offline-ci":["specified","planned","implemented","verified","accepted"]}
...
- [x] **golden-fixtures:** Representative COBOL programs and advanced residual constructs have committed input-output characterization fixtures.; stages: specified, planned, implemented, verified, accepted
- [x] **gate-order:** LLM-assisted outputs are admitted only after schema validation, compilation, characterization tests, and review eligibility checks in that order.; stages: specified, planned, implemented, verified, accepted
- [x] **safe-fallback:** Any failed gate discards the proposal and emits deterministic transliteration plus a traceable manual action item.; stages: specified, planned, implemented, verified, accepted
- [x] **offline-ci:** Deterministic lanes and cache hits run successfully in CI without network access or provider credentials.; stages: specified, planned, implemented, verified, accepted
