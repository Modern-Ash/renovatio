...
satisfied-criteria: ["fixtures","end-to-end","determinism","idempotency","semantic-gaps","equivalence","surface-proof","runbook"]
...
- [x] **surface-proof:** The same project pipeline is reachable through the application service surface and MCP-facing adapter without divergent generation behavior.; stages: specified, planned, implemented, verified, accepted
