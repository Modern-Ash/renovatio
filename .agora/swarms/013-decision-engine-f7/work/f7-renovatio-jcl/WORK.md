...
satisfied-criteria: []
criterion-statuses: {"jcl-parse":["specified","planned","implemented"],"cond-truth-table":["specified","planned","implemented"],"spring-batch-emit":["specified","planned","implemented"],"sort-fixture":["specified","planned","implemented"],"dd-datasets":["specified","planned","implemented"],"missing-proc":["specified","planned","implemented"],"characterization":["specified","planned","implemented"],"defaults-safe":["specified","planned","implemented"]}
...
- [ ] **jcl-parse:** JCL 3-step con COND parsea a BatchJob con conditionGraph correcto; stages: specified, planned, implemented
- [ ] **cond-truth-table:** Semantica COND (skip step si condicion verdadera) cubierta por tabla de verdad + tests dedicados; stages: specified, planned, implemented
- [ ] **spring-batch-emit:** Job de 3 steps encadenados emite spring-batch que ejecuta los 3 programas migrados en orden respetando la condicion; stages: specified, planned, implemented
- [ ] **sort-fixture:** SORT FIELDS= + INCLUDE COND= produce salida identica a fixture de referencia; stages: specified, planned, implemented
- [ ] **dd-datasets:** DD secuencial in/out -> archivos correctos; temp dataset no persiste; stages: specified, planned, implemented
- [ ] **missing-proc:** Proc catalogada faltante -> manual action item, sin crash; stages: specified, planned, implemented
- [ ] **characterization:** Job destino produce los mismos outputs de datos que el batch original para el fixture (harness #122); stages: specified, planned, implemented
- [ ] **defaults-safe:** Sin JCL en el proyecto -> comportamiento actual intacto; stages: specified, planned, implemented
