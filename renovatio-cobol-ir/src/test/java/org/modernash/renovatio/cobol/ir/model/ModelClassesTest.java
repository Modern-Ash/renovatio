...
class ModelClassesTest {
    ...
    void cobolIntermediateModel_builder_shouldBuild_andResolve() {
        ...
        CobolIntermediateModel m = CobolIntermediateModel.builder()
                ...
                .controlFlowGraph(org.modernash.renovatio.cobol.ir.flow.ControlFlowGraph.empty())
                .executionContext(org.modernash.renovatio.cobol.ir.context.CobolExecutionContext.empty())
                .build();
    ...
    void controlFlowGraph_builder_shouldAddEdges_andProvideSuccessors() {
        org.modernash.renovatio.cobol.ir.flow.ControlFlowGraph g = org.modernash.renovatio.cobol.ir.flow.ControlFlowGraph.builder()
