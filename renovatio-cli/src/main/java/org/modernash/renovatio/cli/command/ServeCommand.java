    ...
    public Integer call() {
        ...
        try {
            if (http) {
                ...
                Class<?> clazz = Class.forName("org.modernash.renovatio.mcp.server.McpServerApplication");
                Method main = clazz.getMethod("main", String[].class);
                main.invoke(null, (Object) args);
            } else {
                System.err.println("[renovatio] Starting MCP stdio server...");
                Class<?> clazz = Class.forName("org.modernash.renovatio.mcp.server.McpStdioServerApplication");
                Method main = clazz.getMethod("main", String[].class);
                main.invoke(null, (Object) args);
            }
            return 0;
