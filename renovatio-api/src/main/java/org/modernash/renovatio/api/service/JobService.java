...
import org.modernash.renovatio.api.dto.ProjectDto;
import org.modernash.renovatio.api.dto.JobDto;
...
public class JobService {
    ...
    private Object executeAnalyze(JobEntity entity) {
        ...
        String semanticIrHash = org.modernash.renovatio.profile.MigrationProfiles.sha256(
                org.modernash.renovatio.profile.MigrationProfiles.canonical(result.getData()));
        ...
        List<org.modernash.renovatio.semantic.ir.SemanticProgram> semanticPrograms;
        try {
        ...
        List<org.modernash.renovatio.api.dto.DataAccessDto> dataAccesses =
    ...
    private org.modernash.renovatio.profile.MigrationProfiles.EffectiveProfile requireActiveTarget(String projectId) {
