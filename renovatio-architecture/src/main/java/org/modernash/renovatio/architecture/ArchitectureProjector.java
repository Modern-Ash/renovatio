...
public final class ArchitectureProjector {
    public ArchitectureModel project(DomainModel domain, DecisionSet decisions, String requestHash) {
        ...
        for (DomainModel.DomainNode node : domain.nodes()) {
            ...
            if (decisions.architectureStyle() == org.modernash.renovatio.profile.MigrationProfile.ArchitectureStyle.HEXAGONAL
    ...
    private static ArchitectureModel.ComponentKind primaryKind(DomainModel.DomainNode node,
            org.modernash.renovatio.profile.MigrationProfile.ArchitectureStyle style) {
        ...
        if (node.kind() == DomainModel.Kind.AGGREGATE
                && style == org.modernash.renovatio.profile.MigrationProfile.ArchitectureStyle.HEXAGONAL) {
    ...
    private static boolean isLayered(org.modernash.renovatio.profile.MigrationProfile.ArchitectureStyle style) {
        return style == org.modernash.renovatio.profile.MigrationProfile.ArchitectureStyle.LAYERED
                || style == org.modernash.renovatio.profile.MigrationProfile.ArchitectureStyle.LAYERED_MVC
                || style == org.modernash.renovatio.profile.MigrationProfile.ArchitectureStyle.CLEAN;
    }
