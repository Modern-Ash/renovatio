...
import org.modernash.renovatio.llm.cache.CommittedCacheIndex;
import org.modernash.renovatio.llm.cache.ContentAddressedCache;
import org.modernash.renovatio.llm.cache.ResultDisposition;
import org.modernash.renovatio.llm.cache.VerifiedPromotionManifest;
import org.modernash.renovatio.llm.provider.LlmProvider;
import org.modernash.renovatio.llm.provider.LlmResponse;
import org.modernash.renovatio.llm.provider.ProviderException;
import org.modernash.renovatio.llm.prompt.CatalogFallbackFactory;
import org.modernash.renovatio.llm.prompt.OutputValidationException;
...
public final class GovernedEnrichmentService {
    ...
    private EnrichmentResult miss(PreparedEnrichment prepared, JsonNode deterministicResult, String cacheKey) {
        ...
        try {
            ...
            sanitized = sanitizer.sanitize(fallbackFactory.create(prepared.definition(),
                    org.modernash.renovatio.llm.provider.ProviderFailure.SANITIZATION_REJECTED,
                    deterministicResult));
            disposition = ResultDisposition.DETERMINISTIC_FALLBACK;
        }
