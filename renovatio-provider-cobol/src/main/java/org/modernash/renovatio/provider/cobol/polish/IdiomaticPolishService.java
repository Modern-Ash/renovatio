...
import org.modernash.renovatio.provider.cobol.guardrail.GateCheck;
...
import org.modernash.renovatio.provider.cobol.guardrail.GuardrailGateRunner;
import org.modernash.renovatio.provider.cobol.guardrail.GuardrailRunResult;
...
import org.modernash.renovatio.provider.cobol.guardrail.ProposalManifest;
import org.modernash.renovatio.provider.cobol.guardrail.ReviewEligibilityRequest;
import org.modernash.renovatio.provider.cobol.guardrail.ReviewEligibilityValidator;
...
public final class IdiomaticPolishService {
    ...
    private GuardrailGateRunner gateRunner(PolishProposalRequest request, PolishCandidate candidate,
        ...
        EnumMap<GuardrailGate, org.modernash.renovatio.provider.cobol.guardrail.GateCheck> gates =
