...
public class CoreEngineStandaloneTest {
    ...
    void testProtocolAgnosticDesign() {
        ...
        for (Tool tool : tools) {
            ...
            assertInstanceOf(org.modernash.renovatio.shared.domain.Tool.class, tool);
    ...
    private static class MockLanguageProvider implements LanguageProvider {
        ...
        @Override
        public List<org.modernash.renovatio.shared.domain.Tool> getTools() {
            ...
            return List.of(
                    new org.modernash.renovatio.shared.domain.BasicTool("mock.analyze", "Mock analyze tool", inputSchema),
                    new org.modernash.renovatio.shared.domain.BasicTool("mock.metrics", "Mock metrics tool", inputSchema),
                    new org.modernash.renovatio.shared.domain.BasicTool("mock.plan", "Mock plan tool", inputSchema),
                    new org.modernash.renovatio.shared.domain.BasicTool("mock.apply", "Mock apply tool", inputSchema),
                    new org.modernash.renovatio.shared.domain.BasicTool("mock.diff", "Mock diff tool", inputSchema)
            );
        }
    }
}