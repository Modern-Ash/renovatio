...
@Service
public class TargetEmitterRegistry extends org.modernash.renovatio.shared.emission.TargetEmitterRegistry {
    ...
    public TargetEmitter resolve(MigrationProfile.Language target) {
        ...
        } catch (org.modernash.renovatio.shared.emission.TargetEmitterRegistry.TargetEmitterUnavailableException error) {
    ...
    public EmittedArtifacts emit(TargetModel model, TargetEmitter requestAdapter) {
        try {
            ...
            throw new TargetEmitterUnavailableException(error.requestedTarget(), error.availableTargets());
        } catch (org.modernash.renovatio.shared.emission.TargetEmitterRegistry.DuplicateTargetEmitterException error) {
