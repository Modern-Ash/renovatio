...
import org.modernash.renovatio.shared.dto.RecipeValidationError;
 ...
 * Prefer {@link org.modernash.renovatio.provider.java.OpenRewriteRunner} and
 * associated services from the {@code org.modernash.renovatio} namespace.
 */
...
public class JavaRefactoringService {
    ...
    private final org.modernash.renovatio.provider.java.OpenRewriteRunner delegate;

    public JavaRefactoringService() {
        this(new org.modernash.renovatio.provider.java.OpenRewriteRunner());
    }

    JavaRefactoringService(org.modernash.renovatio.provider.java.OpenRewriteRunner delegate) {
