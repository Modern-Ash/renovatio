package org.modernash.renovatio.mcp.server.service;

import com.fasterxml.jackson.databind.ObjectMapper;
import org.modernash.renovatio.application.capability.SurfaceCapabilityRegistry;
import org.modernash.renovatio.shared.security.WorkspaceRootPolicy;
import org.modernash.renovatio.mcp.server.model.McpPrompt;
import org.modernash.renovatio.mcp.server.model.McpResource;
import org.modernash.renovatio.mcp.server.model.McpTool;
import org.modernash.renovatio.mcp.server.model.ToolCallResult;
import org.modernash.renovatio.core.service.LanguageProviderRegistry;
import org.modernash.renovatio.application.spi.ApplicationCommandBus;
...
public class McpToolingService {
    ...
    public List<McpTool> getMcpTools(String language) {
        ...
        var tools = providerRegistry.generateTools();
        List<org.modernash.renovatio.shared.domain.Tool> filtered = new ArrayList<>();
        for (org.modernash.renovatio.shared.domain.Tool t : tools) {
