...
const AREA_COMMANDS: ReadonlyArray<{ area: RenovatioAreaId; command: Command; keybinding: string }> = [
    ...
    { area: 'changes', command: { id: 'renovatio.shell.changes', label: 'Open Change Sets Area', category: RENOVATIO_CATEGORY }, keybinding: 'ctrlcmd+alt+7' },
    { area: 'equivalence', command: { id: 'renovatio.shell.equivalence', label: 'Open Equivalence Area', category: RENOVATIO_CATEGORY }, keybinding: 'ctrlcmd+alt+8' }
];
