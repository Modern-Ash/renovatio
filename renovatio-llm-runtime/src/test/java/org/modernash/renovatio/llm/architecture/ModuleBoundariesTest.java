package org.modernash.renovatio.llm.architecture;
...
class ModuleBoundariesTest {
    ...
    void cobolIrShouldNotDependOnLlmRuntime() {
        ArchRule rule = ArchRuleDefinition.noClasses()
            .that().resideInAPackage("org.modernash.renovatio.cobol.ir..")
            .should().dependOnClassesThat().resideInAPackage("org.modernash.renovatio.llm.runtime..");
    ...
    void cobolIrShouldNotDependOnLlmAdapter() {
        ArchRule rule = ArchRuleDefinition.noClasses()
            .that().resideInAPackage("org.modernash.renovatio.cobol.ir..")
            .should().dependOnClassesThat().resideInAPackage("org.modernash.renovatio.llm.adapter..");
    ...
    void cobolProviderShouldNotDependOnLlmRuntime() {
        ArchRule rule = ArchRuleDefinition.noClasses()
            .that().resideInAPackage("org.modernash.renovatio.provider.cobol..")
            .should().dependOnClassesThat().resideInAPackage("org.modernash.renovatio.llm.runtime..");
    ...
    void llmRuntimeShouldNotDependOnCobolProvider() {
        ArchRule rule = ArchRuleDefinition.noClasses()
            .that().resideInAPackage("org.modernash.renovatio.llm.runtime..")
            .should().dependOnClassesThat().resideInAPackage("org.modernash.renovatio.provider.cobol..");
    ...
    void llmAdapterShouldNotDependOnCobolProvider() {
        ArchRule rule = ArchRuleDefinition.noClasses()
            .that().resideInAPackage("org.modernash.renovatio.llm.adapter..")
            .should().dependOnClassesThat().resideInAPackage("org.modernash.renovatio.provider.cobol..");
    ...
    void llmSharedDomainShouldNotDependOnLlmRuntime() {
        ArchRule rule = ArchRuleDefinition.noClasses()
            .that().resideInAPackage("org.modernash.renovatio.shared.llm..")
            .should().dependOnClassesThat().resideInAPackage("org.modernash.renovatio.llm.runtime..");
    ...
    void adapterClassesResideInAdapterPackage() {
        ...
        ArchRule rule = ArchRuleDefinition.classes()
            .that().resideInAPackage("org.modernash.renovatio.llm.adapter..")
            .should().resideInAPackage("org.modernash.renovatio.llm.adapter..");
    ...
    void adapterClassesDependOnLlmDomain() {
        ...
        ArchRule rule = ArchRuleDefinition.classes()
            .that().resideInAPackage("org.modernash.renovatio.llm.adapter..")
            .should().dependOnClassesThat().resideInAPackage("org.modernash.renovatio.llm.domain..");
    ...
    void fakeProviderInCorrectPackage() {
        ArchRule rule = ArchRuleDefinition.classes()
            ...
            .should().resideInAPackage("org.modernash.renovatio.llm.provider..");
    ...
    void coreModuleShouldNotDependOnResilience4j() {
        ArchRule rule = ArchRuleDefinition.noClasses()
            .that().resideInAPackage("org.modernash.renovatio.core..")
            .should().dependOnClassesThat().haveNameMatching(".*resilience4j.*");
    ...
    void sharedModuleShouldNotDependOnResilience4j() {
        ArchRule rule = ArchRuleDefinition.noClasses()
            .that().resideInAPackage("org.modernash.renovatio.shared..")
            .should().dependOnClassesThat().haveNameMatching(".*resilience4j.*");
