...
| `COACCT01` | `Coacct01CicsController.java:4: error: package org.springframework.http does not exist import org.springframework.http.ResponseEntity;                                ^ Coacct01CicsController.java:11: e…` |
| `COACTUPC` | `CoactupcCicsController.java:4: error: package org.springframework.http does not exist import org.springframework.http.ResponseEntity;                                ^ CoactupcCicsController.java:11: e…` |
| `COACTVWC` | `CoactvwcCicsController.java:4: error: package org.springframework.http does not exist import org.springframework.http.ResponseEntity;                                ^ CoactvwcCicsController.java:11: e…` |
| `COADM01C` | `Coadm01cCicsController.java:4: error: package org.springframework.http does not exist import org.springframework.http.ResponseEntity;                                ^ Coadm01cCicsController.java:11: e…` |
| `COBIL00C` | `Cobil00cCicsController.java:4: error: package org.springframework.http does not exist import org.springframework.http.ResponseEntity;                                ^ Cobil00cCicsController.java:11: e…` |
| `COCRDLIC` | `CocrdlicCicsController.java:4: error: package org.springframework.http does not exist import org.springframework.http.ResponseEntity;                                ^ CocrdlicCicsController.java:11: e…` |
| `COCRDSLC` | `CocrdslcCicsController.java:4: error: package org.springframework.http does not exist import org.springframework.http.ResponseEntity;                                ^ CocrdslcCicsController.java:11: e…` |
| `COCRDUPC` | `CocrdupcCicsController.java:4: error: package org.springframework.http does not exist import org.springframework.http.ResponseEntity;                                ^ CocrdupcCicsController.java:11: e…` |
| `CODATE01` | `Codate01CicsController.java:4: error: package org.springframework.http does not exist import org.springframework.http.ResponseEntity;                                ^ Codate01CicsController.java:11: e…` |
| `COMEN01C` | `Comen01cCicsController.java:4: error: package org.springframework.http does not exist import org.springframework.http.ResponseEntity;                                ^ Comen01cCicsController.java:11: e…` |
| `COPAUA0C` | `Copaua0cCicsController.java:4: error: package org.springframework.http does not exist import org.springframework.http.ResponseEntity;                                ^ Copaua0cCicsController.java:11: e…` |
| `COPAUS0C` | `Copaus0cCicsController.java:4: error: package org.springframework.http does not exist import org.springframework.http.ResponseEntity;                                ^ Copaus0cCicsController.java:11: e…` |
| `COPAUS1C` | `Copaus1cCicsController.java:4: error: package org.springframework.http does not exist import org.springframework.http.ResponseEntity;                                ^ Copaus1cCicsController.java:11: e…` |
| `COPAUS2C` | `Copaus2cCicsController.java:4: error: package org.springframework.http does not exist import org.springframework.http.ResponseEntity;                                ^ Copaus2cCicsController.java:11: e…` |
| `CORPT00C` | `Corpt00cCicsController.java:4: error: package org.springframework.http does not exist import org.springframework.http.ResponseEntity;                                ^ Corpt00cCicsController.java:11: e…` |
| `COSGN00C` | `Cosgn00cCicsController.java:4: error: package org.springframework.http does not exist import org.springframework.http.ResponseEntity;                                ^ Cosgn00cCicsController.java:11: e…` |
| `COTRN00C` | `Cotrn00cCicsController.java:4: error: package org.springframework.http does not exist import org.springframework.http.ResponseEntity;                                ^ Cotrn00cCicsController.java:11: e…` |
| `COTRN01C` | `Cotrn01cCicsController.java:4: error: package org.springframework.http does not exist import org.springframework.http.ResponseEntity;                                ^ Cotrn01cCicsController.java:11: e…` |
| `COTRN02C` | `Cotrn02cCicsController.java:4: error: package org.springframework.http does not exist import org.springframework.http.ResponseEntity;                                ^ Cotrn02cCicsController.java:11: e…` |
| `COTRTLIC` | `CotrtlicCicsController.java:4: error: package org.springframework.http does not exist import org.springframework.http.ResponseEntity;                                ^ CotrtlicCicsController.java:11: e…` |
| `COTRTUPC` | `CotrtupcCicsController.java:4: error: package org.springframework.http does not exist import org.springframework.http.ResponseEntity;                                ^ CotrtupcCicsController.java:11: e…` |
| `COUSR00C` | `Cousr00cCicsController.java:4: error: package org.springframework.http does not exist import org.springframework.http.ResponseEntity;                                ^ Cousr00cCicsController.java:11: e…` |
| `COUSR01C` | `Cousr01cCicsController.java:4: error: package org.springframework.http does not exist import org.springframework.http.ResponseEntity;                                ^ Cousr01cCicsController.java:11: e…` |
| `COUSR02C` | `Cousr02cCicsController.java:4: error: package org.springframework.http does not exist import org.springframework.http.ResponseEntity;                                ^ Cousr02cCicsController.java:11: e…` |
| `COUSR03C` | `Cousr03cCicsController.java:4: error: package org.springframework.http does not exist import org.springframework.http.ResponseEntity;                                ^ Cousr03cCicsController.java:11: e…` |
...
| --- | --- | --: | :-: | :-: | :-: | --: | --: | --: | --: | --: | --- |
| `CBACT01C` | batch | 430 | yes | yes | no | 3 | 28 | 0 | 0 | 45 | ADD, CALL, CLOSE, CONTINUE, DISPLAY, GOBACK, IF, INITIALIZE, MOVE, OPEN, PERFORM, READ, SET, SUBTRACT, WRITE |
...
| `CBSTM03A` | batch | 924 | yes | yes | no | 3 | 54 | 0 | 0 | 57 | ADD, CALL, CLOSE, COMPUTE, CONTINUE, DISPLAY, EVALUATE, GO TO, GOBACK, IF, INITIALIZE, MOVE, OPEN, PERFORM, SET, STRING, WRITE |
...
| `COADM01C` | cics-online | 288 | yes | yes | no | 4 | 11 | 0 | 0 | 13 | CONTINUE, EVALUATE, EXEC CICS, IF, INSPECT, MOVE, PERFORM, SET, STRING |
...
| `COMEN01C` | cics-online | 308 | yes | yes | no | 4 | 68 | 0 | 0 | 81 | CONTINUE, EVALUATE, EXEC CICS, IF, INSPECT, MOVE, PERFORM, SET, STRING |
...
| `COPAUS0C` | ims-mq | 1032 | yes | yes | no | 4 | 223 | 0 | 0 | 241 | COMPUTE, CONTINUE, EVALUATE, EXEC CICS, EXEC DLI, IF, INITIALIZE, MOVE, PERFORM, READ, SET, STRING |
...
| `CORPT00C` | cics-online | 649 | yes | yes | no | 4 | 139 | 0 | 0 | 74 | ADD, CALL, COMPUTE, CONTINUE, DISPLAY, EVALUATE, EXEC CICS, GO TO, IF, INITIALIZE, MOVE, PERFORM, SET, STRING, WRITE |
| `COSGN00C` | cics-online | 260 | yes | yes | no | 4 | 62 | 0 | 0 | 79 | CONTINUE, EVALUATE, EXEC CICS, IF, MOVE, PERFORM, READ, SET |
| `COTRN00C` | cics-online | 699 | yes | yes | no | 4 | 122 | 0 | 0 | 197 | COMPUTE, CONTINUE, DISPLAY, EVALUATE, EXEC CICS, IF, MOVE, PERFORM, SET, SUBTRACT |
...
| `COUSR00C` | cics-online | 695 | yes | yes | no | 4 | 121 | 0 | 0 | 211 | COMPUTE, CONTINUE, DISPLAY, EVALUATE, EXEC CICS, IF, MOVE, PERFORM, SET, SUBTRACT |
